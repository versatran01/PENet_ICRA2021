...
parser.add_argument(
    '--data-folder',
    default='/home/chao/Workspace/dataset/kitti',
    type=str,
    metavar='PATH',
...
parser.add_argument(
    '--data-folder-save',
    default='/home/chao/Documents/kitti/submit_test/',
    type=str,
    metavar='PATH',
...
# random cropping
parser.add_argument(
    '--not-random-crop', action="store_true", default=False, help='prohibit random cropping')
parser.add_argument(
    '-he', '--random-crop-height', default=320, type=int, metavar='N', help='random crop height')
parser.add_argument(
    '-w', '--random-crop-width', default=1216, type=int, metavar='N', help='random crop height')
...
parser.add_argument(
    '-d', '--dilation-rate', default="2", type=int, choices=[1, 2, 4], help='CSPN++ dilation rate')

args = parser.parse_args()
args.result = "/home/chao/Workspace/log/penet"
    ...
    for i, batch_data in enumerate(loader):
        ...
        with torch.no_grad():
            ...
            if mode != 'test_prediction' and mode != 'test_completion':
                ...
                if mode != 'train':
                    logger.conditional_print(mode, i, epoch, lr, len(loader), block_average_meter,
                                             average_meter)
...
def main():
    ...
    if args.freeze_backbone:
        ...
        optimizer = torch.optim.Adam(
            model_named_params, lr=args.lr, weight_decay=args.weight_decay, betas=(0.9, 0.99))
    # elif args.network_model == 'pe':
    #     model_bone_params = [p for _, p in model.backbone.named_parameters() if p.requires_grad]
    ...
    #     optimizer = torch.optim.Adam(
    #         [{'params': model_bone_params, 'lr': args.lr / 10}, {'params': model_new_params}],
    #         lr=args.lr,
